###
# This is copied and modified from angular-bootstra-slider as a temporary hack for performance reasons.
#
# This may be a bad idea, and I don't fully understand the consequences of what I've done.  So there's that...
###
    ...
    .directive('slider', ['$parse', '$timeout', '$rootScope', function ($parse, $timeout, $rootScope) {
        return {
            ...
            link: function ($scope, element, attrs, ngModelCtrl, $compile) {
                ...
                // HACKED for performance... we never update these dynamically so no watching
